      ...
      >
        <div className="relative w-full min-h-[500px] sm:min-h-[600px] lg:min-h-[650px] overflow-hidden">
          <Image
            ...
            unoptimized
          />
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 sm:gap-4 py-4 px-2 overflow-hidden">
            <div className="relative flex items-center justify-center w-full max-w-xs sm:max-w-sm lg:max-w-md shrink-0">
              <Image
                ...
                width={313}
                height={289}
                className="w-full h-auto max-w-60 sm:max-w-64 lg:max-w-72"
                quality={100}
                priority
                unoptimized
              />
            ...
            <div className="flex items-center justify-center w-full px-2 sm:px-4 pb-4">
              <div className="w-full max-w-xs sm:max-w-sm lg:max-w-lg">
                ...
                >
                  <div className="bg-white p-[1] w-full">
                    <div className="box-shadow-about-whiteboard p-1 sm:p-2 lg:p-3 gap-1 w-full">
