  ...
  return (
    ...
    >
      <div className="flex flex-col items-start justify-center w-full h-full font-pp-mondwest text-[#602C2C] gap-1 md:gap-2.5 pt-2 pl-0.5 sm:pl-1.5">
        ...
        <div className="flex flex-row items-center justify-between w-full gap-1 xs:gap-2 h-3">
          <div className="flex flex-row items-center gap-1 xs:gap-2 relative group">
            <h6
              className="text-[0.5rem] sml:text-[0.5625rem] sm:text-sm whitespace-nowrap max-w-[5rem] md:max-w-[7.5rem] truncate pointer-events-none"
      ...
      <div className="relative flex flex-col items-center justify-center w-full mt-2">
        <div className="relative w-full max-w-[17.5rem] sm:max-w-sm md:max-w-md h-auto flex items-center justify-center">
          <Image
          ...
          {/* content */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-4 sml:-translate-y-5 md:-translate-y-8 text-[0.375rem] sml:text-[0.5rem] md:text-sm text-[#602C2C] font-pp-neuebit w-full px-3.5 sml:px-5 sm:px-6 md:px-8 max-w-[120vw] max-h-[2.8125rem] sml:max-h-[3.75rem] md:max-h-[6.25rem] whitespace-normal sm:max-w-full overflow-auto">
